        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open( array('route' => 'sections.store', 'id' => 'form', 'class' => 'form-horizontal')) !!}
        ...
        <tr>
         ...
         <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class = 'btn btn-danger btn-xs' href = 'sections/{{$value->id}}/delete' ><i class = 'material-icons'>delete</i></a>
                    <a class = 'btn btn-primary btn-xs setupajax' href = 'sections/{{$value->id}}/edit'><i class = 'material-icons'>edit</i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
